  ...
  <div className="w-full relative flex items-center justify-center h-auto md:h-170" style={{ height: `${height}px` }}>
    ...
    <div className="max-w-315 mx-auto absolute inset-0 z-10 flex flex-col justify-center text-white px-4">
      ...
      <div className='w-full md:max-w-215 mx-auto md:mx-16 border-2 border-[#ffffff15] px-6 py-8 my-16'>
        <div>
          <p
            className="text-1xl md:text-2xl semibold drow-shadow-lg mb-0">
              The leap that strengthens trust and credibility
          </p>

          <h1
            className="text-4xl md:text-5xl font-(family-name:--font-baskerville) leading-12 md:leading-16 font-bold drop-shadow-lg mb-6 mt-0">{title}
          </h1>
        ...
        <div className='flex gap-1.5 md:gap-3 py-5'>
          <Link
            href="/services" className="inline-flex items-center justify-center bg-blue-800 text-white px-7 py-2 rounded-md hover:bg-blue-900 transition-colors cursor-pointer"
          >
            Learn more
          </Link>
